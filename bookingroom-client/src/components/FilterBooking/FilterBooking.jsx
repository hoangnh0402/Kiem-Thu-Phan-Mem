...
function FilterBooking({ filter }) {
  ...
  const [expectedCheckIn, setExpectedCheckIn] = useState(setDateFormat(new Date(), 'checkin'))

  const [expectedCheckOut, setExpectedCheckOut] = useState(setDateFormat(new Date(), 'checkout'))
